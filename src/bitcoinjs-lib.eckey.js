...
Bitcoin.ECKey = (function () {
	...
	ECKey.privateKeyPrefix = 0xA4; // mainnet 0xA4    testnet 0xDF
	...
	*/
	...
	ECKey.isWalletImportFormat = function (key) {
		key = key.toString();
		return (ECKey.privateKeyPrefix == 0xA4) ?
							(/^[6F][123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{50}$/.test(key)) :
